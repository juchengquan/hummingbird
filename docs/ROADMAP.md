...
(scheduling) remains in the agent-task arc. Code-cleanup Phases 1–6
shipped via #96 + #102 — lint baseline now 0 warnings, sync test
...
ships the end-to-end loop with no DB changes.)
