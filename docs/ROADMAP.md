...
Last updated: 2026-05-28 (project mode Phases 1–2 shipped — schema +
toggle + Kanban board; AI breakdown + run-as-task pending.
...
| When | Feature | Where |
|---|---|---|
| 2026-05-28 | **Project mode — Phase 2** (Kanban board): `projectTasks` store slice + mutators, pure reorder helper, `project_tasks` sync (diff/reconcile/bulk-upload), gated Tasks rail tab (desktop + mobile), dnd-kit board with manual add / drag / delete | [PLAN](PLAN-project-mode.md) · [#82](https://github.com/juchengquan/hummingbird/pull/82) |
...
| 🪜 [Project mode](PLAN-project-mode.md) | Phases 1–2 shipped (#64, #82) | Workspace → goal + milestones + Kanban tasks. Schema + toggle + board (CRUD/drag/sync) done; Phases 3–5 (AI breakdown, run-as-task, polish) pending |
