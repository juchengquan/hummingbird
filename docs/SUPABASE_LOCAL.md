...
- All eight migrations (`supabase/migrations/0001_schema.sql`,
  ...
  `0008_message_compression.sql`) apply identically. `0005_mcp.sql`
  enables `pgcrypto` itself — no separate extension toggle.
