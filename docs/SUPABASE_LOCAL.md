...
- All six migrations (`supabase/migrations/0001_schema.sql`,
  `0002_rls_policies.sql`, `0003_storage.sql`,
  `0004_conversation_files.sql`, `0005_mcp.sql`,
  `0006_url_bookmarks.sql`) apply identically. `0005_mcp.sql` enables
  `pgcrypto` itself — no separate extension toggle.
