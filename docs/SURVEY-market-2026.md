...
3. **Deep Research mode** — highest distinctiveness-per-effort given the
   ...
   medium-large._ ✅ Plan + all 4 phases shipped ([`_done/PLAN-deep-research.md`](_done/PLAN-deep-research.md) — #99 / #101 / #103 / #104 / #105 / #106).
...
5. **Custom agents / personas with scoped tool perms** — unlocks future
   ...
   _Effort: medium._ ✅ Plan + all 3 phases shipped ([`_done/PLAN-custom-agents.md`](_done/PLAN-custom-agents.md) — #107 / #110).
